...
culture_ans_dict = {'The Globe Theatre': ['The Globe Theatre', 'The Royal Opera House', 'The Apollo Victoria Theatre',
                    ...
                    'The Inca civilization': ['The Inca civilization', 'The Aztec civilization',
                                              'The Mayan civilization', 'The Ancient Egyptians'],
                    ...
                    'The 12 Grapes of Luck': ['The 12 Grapes of Luck', 'Grape juggling', 'Grape stomping',
                                              'Grape sacrifice'],
                    ...
                    'Wai': ['Wai', 'Sawadee Ka', 'Thai Clasp', 'Namaste'],
                    'Thumbs up or thumbs down': ['Thumbs up or thumbs down', 'Nod up or Nod down',
                                                 'Open palm or Closed Fist', 'One finger up or Two fingers up'],
                    'Afternoon tea': ['Afternoon tea', 'High Tea', 'Tea Time', 'Late Lunch Tea'],
                    'Leaving a pebble': ['Leaving a pebble', 'Memorial Pebbles', 'Stone Offering', 'Rock Tribute'],
                    'Ceilidh': ['Ceilidh', 'Hogmanay', 'Bagpipe Ball', 'Haggis'],
                    'Origata': ['Origata', 'Origami', 'Furoshiki', 'Kanzashi'],
                    'New Year\'s Eve celebration': ['New Year\'s Eve celebration', 'Nocturnal Year\'s Welcome',
                                                    'Midnight Fireworks Extravaganza', 'Yearly Countdown Spectacular'],
                    'Lei': ['Lei', 'Haku', 'Luau', 'Maile'],
                    'Germany': ['Germany', 'Austria', 'Switzerland', 'Belgium'],
                    'Kimono': ['Kimono', 'Yukata', 'Haori', 'Hakama'],
                    'Haida': ['Haida', 'Navajo', 'Cherokee', 'Sioux'],
                    'Shamrock': ['Shamrock', 'Clover', 'Leprechaun\'s Delight', 'Emerald Blossom'],
                    'Jørn Utzon': ['Jørn Utzon', 'Frank Gehry', 'Le Corbusier', 'I. M. Pei'],
                    'Rwanda': ['Rwanda', 'Uganda', 'Ethiopia', 'Burundi'],
                    'Homer': ['Homer', 'Virgil', 'Sophocles', 'Aristotle'],
                    'Athens, Greece': ['Athens, Greece', 'Rome, Italy', 'Istanbul, Turkey', 'Barcelona, Spain'],
                    'English': ['English', 'Spanish', 'Arabic', 'Chinese'],
                    'Tintagel Castle': ['Tintagel Castle', 'Camelot Castle', 'Arthur\'s Keep', 'Excalibur Abbey'],
                    'Farsi': ['Farsi', 'Persian', 'Iranic', 'Teheranese'],
                    'Czech Republic': ['Czech Republic', 'Austria', 'Hungary', 'Poland'],
                    'Sweden': ['Sweden', 'Norway', 'Denmark', 'Finland'],
                    'Tulip': ['Tulip', 'Rose', 'Peony', 'Orchid'],
                    'Hopi': ['Hopi', 'Navajo', 'Zuni', 'Cherokee'],
                    'Amelia Earhart': ['Amelia Earhart', 'Bessie Coleman', 'Harriet Quimby', 'Jacqueline Cochran'],
                    'South Africa': ['South Africa', 'Kenya', 'Ethiopia', 'Tanzania']
                    }
